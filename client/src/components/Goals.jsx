...
const Goals = () => {
  ...
  return (
    <div
      ref={textRef}
      className="relative py-20 md:py-32 bg-secondary/50 min-h-screen flex flex-col justify-center items-center dark:bg-card/50 mt-10"
    >
      ...
      <div className="absolute h-[200px] w-auto object-contain bottom-0">
        <img
          src={HeroGroup}
          alt="HeroGroup"
